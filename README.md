...
* **Sprint 5:** Cree las carpetas views y arme las vistas para el main, products, details, profile, register e index. Instale Socket.io y handlebars, en la barra de navegacion se encuentra el logo que lleva siempre al index, el link de productos que muestra todos los productos, el boton de login para iniciar sesion, el de registrarse que registra a los usuarios y el de profile que muestra un unico usuario del readOne, se puede ver y navegar desde la ruta http://localhost:8080.
